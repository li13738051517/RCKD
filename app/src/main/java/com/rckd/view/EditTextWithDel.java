...
import static com.litesuits.android.log.LogReader.TAG;
...
public class EditTextWithDel extends android.support.v7.widget.AppCompatEditText {
    ...
    private void init() {
        imgInable = mContext.getResources().getDrawable(R.drawable.cl);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (imgInable != null && event.getAction() == MotionEvent.ACTION_UP) {
            ...
            android.util.Log.e(tag, " eventX = " + eventX + " ; eventY =  " + eventY);
            Rect rect = new Rect();
