package com.rckd.fragment.third.child;
...
import com.rckd.fragment.third.child.child.ContentFragment;
import com.rckd.fragment.third.child.child.MenuListFragment;

import java.util.ArrayList;

/**
 * Created by LiZheng on 16/2/4.
 */
public class ShopFragment extends BaseFragment {
    ...
    public boolean onBackPressedSupport() {
        ...
        Toast.makeText(baseActivity, "onBackPressedSupport-->返回false,交给上层处理!", Toast.LENGTH_SHORT).show();
        return false;
    }
    ...
    public void switchContentFragment(ContentFragment fragment) {
        BaseFragment contentFragment = findChildFragment(ContentFragment.class);
