...
/**
 * @Hiden
 * Created by LiZheng dispatch 16/11/28.
 */
...
//                break;
    ...
    private void dispatchFragmentEnterAnimatidispatchEnd(BaseFragment fragment, Bundle savedInstanceState) {
        for (int i = 0; i < mFragmentLifecycleCallbacks.size(); i++) {
...
//    private void dispatchFragmentCreateView(BaseFragment fragment, Bundle savedInstanceState) {
//        for (int i = 0; i < mFragmentLifecycleCallbacks.size(); i++) {
