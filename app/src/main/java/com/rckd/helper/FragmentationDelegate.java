...
import com.rckd.debug.DebugFragmentRecord;
import com.rckd.debug.DebugHierarchyViewContainer;
...
public class FragmentationDelegate {
    private static final String TAG = FragmentationDelegate.class.getName();
    ...
    public static final String FRAGMENTATION_STATE_SAVE_IS_INVISIBLE_WHEN_LEAVE = "fragmentation_state_save_invisible_when_leave";
    ...
    public FragmentationDelegate(BaseActivity activity) {
        Log.e(TAG, " FragmentationDelegate start ");
        this.mActivity = activity;
        mHandler = mActivity.getHandler();
        Log.e(TAG, " FragmentationDelegate over ");
    }
     ...
     * 加载多个根Fragment
     */
    public void loadMultipleRootTransaction(FragmentManager fragmentManager, int containerId, int showPosition, BaseFragment... tos) {
     ...
     * @param type        类型
     */
    public void dispatchStartTransaction(FragmentManager fragmentManager, BaseFragment from, BaseFragment to, int requestCode, int launchMode, int type) {
     ...
     */
    public void replaceTransaction(BaseFragment from, BaseFragment to, boolean addToBack) {
    ...
    public <T extends BaseFragment> T findStackFragment(Class<T> fragmentClass, String toFragmentTag, FragmentManager fragmentManager) {
        fragmentManager = checkFragmentManager(fragmentManager, null);
        if (fragmentManager == null) return null;
     ...
     */
    public boolean dispatchBackPressedEvent(BaseFragment activeFragment) {
    ...
    private void debouncePop(BaseFragment from, FragmentManager fragmentManager) {
        // Debounce
        if (from == null) {
     ...
     */
    public void popTo(String fragmentTag, boolean includeSelf, Runnable afterPopTransactionRunnable, FragmentManager fragmentManager) {
        fragmentManager = checkFragmentManager(fragmentManager, null);
        if (fragmentManager == null) return;
