 ...
 * or BaseActivity/SupportFragment.startXXX()}
 * <p>
 * Created by LiZheng on 16/11/24.
 */
public abstract class SupportTransaction {
    ...
    /**
     * start a BaseFragment for which you would like a result when it exits.
     *
     ...
     */
    public abstract <T extends BaseFragment> T commit();

    /**
     * Add some action when calling {@link BaseFragment#start(BaseFragment)
     * or BaseActivity/SupportFragment.startXXX()}
     */
    public final static class SupportTransactionImpl<T extends BaseFragment> extends SupportTransaction {
        private T mSupportFragment;
        private TransactionRecord mRecord;

        public SupportTransactionImpl(T supportFragment) {
